...
public class Domo {
	...
	static int[] test(int[] A) {
        ...
        for(int i=0; i<n; i++){
            ...
            actual_square_sum = actual_square_sum + A[i]*A[i];
        }
        System.out.println("Actual sum"+actual_sum);
        System.out.println("Square sum"+square_sum);
        
        int a_b = sum - actual_sum;
        int as_bs = square_sum - actual_square_sum;
        int apb = as_bs/a_b;
